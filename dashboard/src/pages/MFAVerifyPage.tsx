        ...
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4 relative overflow-hidden selection:bg-indigo-500/30">
            ...
            <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="text-center mb-8">
                    ...
                    <div className={`inline-flex items-center justify-center w-12 h-12 rounded-full mb-4 ${currentMethod === 'telegram' ? 'bg-blue-500/20' : 'bg-purple-500/20'
                        }`}>
                ...
                <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-8 shadow-2xl">
                        ...
                        <div className="flex gap-2 mb-6">
                            {availableMethods.includes('telegram') && (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl text-sm font-medium transition-all ${currentMethod === 'telegram'
                            ...
                            {availableMethods.includes('totp') && (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl text-sm font-medium transition-all ${currentMethod === 'totp'
                    ...
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 py-3.5 px-4 text-white font-medium rounded-xl shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none ${isBackupCode
